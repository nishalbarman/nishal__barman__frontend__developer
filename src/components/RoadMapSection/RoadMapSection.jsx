...
function RoadMapSection() {
  return (
    <div className="bg-black w-[100%] h-fit flex flex-col items-center text-white">
      <div className="bg-roadmap-bg bg-no-repeat w-[100%] flex flex-col items-center pt-[6rem] pb-[6rem] p-[0px_13%]">
        <div className="flex flex-col items-center w-[100%] gap-[7rem]">
          <h3 className="text-samurai-red font-shojumaru text-[4.092rem]">
            Road Map
          </h3>
          <div className="flex items-center justify-center flex-wrap gap-[9rem] w-[100%] h-[100%]">
            <RoadMapItem
